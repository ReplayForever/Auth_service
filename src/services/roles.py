...
class RoleGetService(AbstractService, RolesCommon):
...
class RoleCreateService(CreateAbstractService, RolesCommon):
    def __init__(self, db: AsyncSession, authorize: AuthJWT):
        self._db = db
        self._authorize = authorize
...
class RoleDeleteService(DeleteAbstractService, RolesCommon):
    def __init__(self, db: AsyncSession, authorize: AuthJWT):
        self._db = db
        self._authorize = authorize
...
class RoleUpdateService(PatchAbstractService, RolesCommon):
    def __init__(self, db: AsyncSession, authorize: AuthJWT):
        self._db = db
        self._authorize = authorize
...
def get_role_create_service(
    ...
    return RoleCreateService(db, authorize)
...
def get_role_get_service(
    ...
    return RoleGetService(db, authorize)
...
def get_role_delete_service(
    ...
    return RoleDeleteService(db, authorize)
...
def get_role_update_service(
    ...
    return RoleUpdateService(db, authorize)
